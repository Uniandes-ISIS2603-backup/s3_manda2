...
/** servicio1 */
insert into SERVICIOENTITY (ID, DTYPE, CALIFICACION, COSTO, DESCRIPCION, ESTADO, NOMBRE, PUNTODEENCUENTRO, PUNTODEREALIZACION, CLIENTE_ID, EMPLEADO_ID, COSTODETRANSPORTE, PORCENTAJEEXTRA,DESPLAZAMIENTO) values (1000, 'EntregasDeDocumentosEntity', 4.0, 15000, 'Llevar carta a gerente general', 'EN_DESARROLLO','Entrega de documento a bancolombia','Pan Pa Ya 116','Bancolombia calle 72',1000,2000,8000,0.3,0);
